...
export ACE_DOCKER_BASE_DIR=/ace/ace-docker-projects/ace-docker-projects/docker
...
export ACE_NEXUS3_IP=172.20.0.7
...
export ACE_ROCKETMQ_NAMESRV_IP=172.18.0.11
export ACE_ROCKETMQ_BROKER_IP=172.18.0.12
export ACE_ROCKETMQ_BROKER_CONF_PATH=${ACE_DOCKER_BASE_DIR}/../ace-docker-rocketmq-broker/data/broker.conf
export ACE_ROCKETMQ_CONSOLE_IP=172.18.0.13
# 微服务配置
export ACE_ACCOUNT_BASE_API_WEB_IP=172.18.10.1
export ACE_ACCOUNT_CAS_BASE_API_WEB_IP=172.18.10.2
